...
**핵심 기능**
- 오늘의 인기 협찬 5개 테이블 (지역·경쟁률·체험가치·D-day)
- 자연어 니즈 탐색 — **지역+업종** 파싱 (`서울쪽 레스토랑 협찬` 등)
- **마감 임박 협찬** D-0/D-1 전용 조회 (`get_urgent_campaigns`)
- 네이버 쇼핑 시장가 비교 (선택 연동)
- 블로그 URL 기반 신청 한마디 3문장 생성
- 협찬 적성 테스트 + 프로필 저장 (Stateless + set_profile)
- blogreviewzip **28개 팁** 전수 (선정률·플랫폼·광고표기·AI브리핑 등)
...
기술 문서 → [docs/DEPLOY_KC.md](docs/DEPLOY_KC.md) · [docs/PLAYMCP_EXAMPLES.md](docs/PLAYMCP_EXAMPLES.md) · [docs/기획서/TOOL_SPEC.md](docs/기획서/TOOL_SPEC.md)
